...
CREATE TABLE Users (
  user_id VARCHAR(5) PRIMARY KEY NOT NULL, -- known to app admin
...
INSERT INTO Users
VALUES 
("ID001", "DesiP", "dp@mail.com", "password!", "admin", "2000-01-01"),
("ID002", "HannahC", "hc@mail.com", "password2", "admin", "1999-02-02"),
("ID003", "KatF", "kf@mail.com", "password3", "user", "1998-03-03"),
("ID004", "KoniB", "kb@mail.com", "password4)", "user", "1997-04-04"),
("ID005", "MahumK", "mk@mail.com", "password5", "user", "1996-05-05"),
("ID006", "MariaP", "mp@mail.com", "password6", "user", "1995-06-06"),
("ID007", "RahaT", "rt@mail.com", "password7", "user", "1995-07-07")
